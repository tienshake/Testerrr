...
driver.find_element(By.CSS_SELECTOR, '#root > div > div.Login_container__l\+22X > div.Login_content__Clzqv > div.Login_body__t6Xgp > div > div:nth-child(1) > div > div.FormInput_inputWrap__mjtRx > input').send_keys('tien48026@donga.edu.vn')
#Step 6: Nhập password vào ô nhập password
driver.find_element(By.CSS_SELECTOR, '#root > div > div.Login_container__l\+22X > div.Login_content__Clzqv > div.Login_body__t6Xgp > div > div:nth-child(2) > div > div.FormInput_inputWrap__mjtRx > input[type=password]').send_keys('12345678')
