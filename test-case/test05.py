...
driver.find_element(By.CSS_SELECTOR, '#root > div > div.Login_container__l\+22X > div.Login_content__Clzqv > div.Login_body__t6Xgp > div > div:nth-child(1) > div > div.FormInput_inputWrap__mjtRx > input[type=text]').send_keys('0339558998')
